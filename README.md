...
On a aussi commencé à regrouper les réponses de sondage, pour obtenir les pourcentage de "préférence" et faire fonctionner la fonction "score_de_première_période" (code de CA).
